...
package com.emc2zen.serverside {
	...
	*/
	...
	/**
	* Capa de dato del modelo de implementacion de EVENTOS para el entorno de CONEXIONES.
	* @author	PollyJex
	*/
	public class ConexionEvent extends CoreEvent {
		...
		* @return	ConexionEvent
		*/
		public function ConexionEvent( type:String, property:* = null, bubbles:Boolean = false, cancelable:Boolean = false ) {
