...
package com.emc2zen.serverside {
	...
	*/
	...
	/**
	* Capa de dato del modelo de implementacion de EVENTOS para el entorno de FILET RANSFER.
	* @author	PollyJex
	*/
	public class FileTransferEvent extends CoreEvent {
		
		/**
		 * Evento COMPLETE_QUEUE.
		 */
		public static const COMPLETE_QUEUE:String = "onCompleteQueue";
		...
		*/
		public function FileTransferEvent( type:String, property:* = null, bubbles:Boolean = false, cancelable:Boolean = false ) {
