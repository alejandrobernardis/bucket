...
__project_full_name__ = 'Figment, Feedback'
__project_owner__ = 'Figment/Kinetiq, inc'
...
from com.feedback.core.utils import import_module, import_by_path
...
class MainApplication(Application):
    def __init__(self):
        ...
        for key, value in settings.UI_MODULES.items():
            try:
    ...
    def session_client(self):
        if not self._session_client:
            self._session_client = KeyValueClientFactory.make(
                self.session_config
            )
