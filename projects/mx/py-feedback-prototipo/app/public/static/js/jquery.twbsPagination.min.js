    ...
    TwbsPagination.prototype = {
        ...
        buildListItems: function (pages) {
            ...
            if (this.options.prev) {
                var start_page = this.options.startPage,
                    prev_page = (start_page < 3) ? 1 : start_page - 1 ;
                $listItems = $listItems.add(this.buildItem('prev', prev_page));
            }
            ...
            if (this.options.next) {
                var start_page = this.options.startPage,
                    next_page = (start_page == 1 && pages.length > 1) ? 2 :
                        (start_page >= this.options.totalPages) ? start_page : start_page + 1;
                $listItems = $listItems.add(this.buildItem('next', next_page));
            }
