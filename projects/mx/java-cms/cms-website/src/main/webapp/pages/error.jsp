...
<html>
  ...
  <body >
    ...
    <table align="center"><tr><td class="message2">
    	La página no puede ser mostrada, Lamentamos si esta situación le causa algun inconveniente<br/><br/>
    	Page can not be shown, We are sorry for the inconvenient<br/><br/>
