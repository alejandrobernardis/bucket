package activia.simon.avatar{
	 ...
	 * @author bernardisa
	 */
	public class Step3Screen extends BaseScreen {
		
		private var _simon:Simon;
		private var _queue:Array;

		public function Step3Screen(data : XML = null, autorelease : Boolean = true) {
		...
		override protected function $config(e:Event):void{
			...
			var list:Array = new Array("accessory_hair", "accessory_body", "accessory_foot");
			var category:String;
