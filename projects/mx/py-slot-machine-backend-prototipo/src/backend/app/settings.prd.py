...
SOCIAL_DATABASE_PORT = 27100
SOCIAL_DATABASE_CONN = 100
SOCIAL_DATABASE_AREQ = True
SOCIAL_DATABASE_UGLS = True
SOCIAL_DATABASE_USER = 'c8admin'
SOCIAL_DATABASE_PASS = ''


TRACK_DATABASE_HOST = 'localhost'
TRACK_DATABASE_PORT = 27200
TRACK_DATABASE_CONN = 100
TRACK_DATABASE_AREQ = True
TRACK_DATABASE_UGLS = True
TRACK_DATABASE_USER = 'c8admin'
TRACK_DATABASE_PASS = ''
